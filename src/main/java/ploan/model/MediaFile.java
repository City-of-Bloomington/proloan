...
public class MediaFile implements java.io.Serializable{
	...
	String link = "";
	if(obj_type.equals("Loan")){
	    link = "Loan?action=zoom&lid="+obj_id;
	}
	else if(obj_type.equals("Property")){
	    link = "Property?pid="+obj_id;						
	}
	else if(obj_type.equals("Client")){
	    link = "Client?cid="+obj_id;						
	}
	return link;
    }
	...
	if(file_ext == null)
	    file_ext="";
	if(!id.equals("")){
	    file_name = "proloan_"+id+"."+file_ext; 
	}
	return file_name;
    }
    @Override
